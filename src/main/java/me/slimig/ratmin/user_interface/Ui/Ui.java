                                ...
                                .addGroup(gl_settingspanel.createParallelGroup(Alignment.LEADING)
                                        .addGroup(gl_settingspanel.createSequentialGroup()
                                                .addGroup(gl_settingspanel.createParallelGroup(Alignment.TRAILING)
                                                        .addComponent(chckbxListenOnStart, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                                                        .addGroup(gl_settingspanel.createSequentialGroup()
                                                                .addComponent(lblPortToListen)
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addComponent(spinner, GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)))
                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                .addComponent(listenerbtn, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
                                                .addGap(255))
                                        .addGroup(gl_settingspanel.createSequentialGroup()
                                                .addComponent(chckbxForwardPortUsing, GroupLayout.PREFERRED_SIZE, 335, GroupLayout.PREFERRED_SIZE)
                                                .addContainerGap())
                                        .addGroup(gl_settingspanel.createSequentialGroup()
                                                .addComponent(chckbxShow, GroupLayout.PREFERRED_SIZE, 350, GroupLayout.PREFERRED_SIZE)
                                                .addContainerGap())))
        );
        gl_settingspanel.setVerticalGroup(
                gl_settingspanel.createParallelGroup(Alignment.TRAILING)
                        .addGroup(gl_settingspanel.createSequentialGroup()
                                ...
                                .addGap(18)
                                .addComponent(chckbxListenOnStart)
                                .addPreferredGap(ComponentPlacement.UNRELATED)
                                .addComponent(chckbxForwardPortUsing, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                                ...
                                                .addGroup(gl_builderpanel.createParallelGroup(Alignment.LEADING)
                                                        ...
                                                        .addGroup(gl_builderpanel.createParallelGroup(Alignment.TRAILING)
                                                                .addGroup(gl_builderpanel.createParallelGroup(Alignment.LEADING)
                                                                        ...
                                                                        .addComponent(fname, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE))
                                                        ...
                                                        .addComponent(ipname, 201, 201, 201))
                                                .addGap(229))
                                        .addGroup(gl_builderpanel.createSequentialGroup()
                                                .addComponent(chckbxAutostartwindowsOnly, GroupLayout.PREFERRED_SIZE, 248, GroupLayout.PREFERRED_SIZE)
                                                .addContainerGap())
                                        .addGroup(Alignment.TRAILING, gl_builderpanel.createSequentialGroup()
                                                .addGroup(gl_builderpanel.createParallelGroup(Alignment.TRAILING)
                                                        .addComponent(chckbxObfuscate, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
